...
if not on_dotcloud:
    STATICFILES_DIRS = ('/home/bitnami/PycharmProjects/bookhounds/static',
    )
if on_dotcloud:
    STATICFILES_DIRS = (
...
ROOT_URLCONF = 'bookhounds.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bookhounds.wsgi.application'


if not on_dotcloud:
    TEMPLATE_DIRS = ('/home/bitnami/PycharmProjects/bookhounds/templates',
        )
if on_dotcloud:
